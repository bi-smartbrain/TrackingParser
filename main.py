...
def run_tracking():
    ...
    tracking_report(rubrain_url, 2, 2026, auth_token, rubrain_result_spread)
    tracking_report(rubrain_url, 3, 2026, auth_token, rubrain_result_spread)
    ...
    tracking_report(junbrain_url, 2, 2026, auth_token, junbrain_result_spread)
    tracking_report(junbrain_url, 3, 2026, auth_token, junbrain_result_spread)
